...
check_audio_file "$AUDIO_DIR/weapons/weapon_shotgun.ogg" 200 "weapon"
check_audio_file "$AUDIO_DIR/weapons/sniper_rifle.ogg" 200 "weapon"
check_audio_file "$AUDIO_DIR/weapons/weapon_flamethrower.ogg" 200 "weapon"
check_audio_file "$AUDIO_DIR/weapons/laser_rifle.ogg" 200 "weapon"
check_audio_file "$AUDIO_DIR/weapons/weapon_minigun.ogg" 200 "weapon"
...
check_audio_file "$AUDIO_DIR/ui/ui_error.ogg" 50 "ui"
echo ""
